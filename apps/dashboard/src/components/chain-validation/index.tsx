...
const StatusCheck = (props: {
  ...
  switch (props.status) {
    case "error":
      return <AlertCircleIcon className="text-destructive-text" />;
    case "warning":
      return <AlertCircleIcon className="text-warning-text" />;
    case "success":
      return <CheckCircleIcon className="text-success-text" />;
  }
};
